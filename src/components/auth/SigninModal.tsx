        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
            <div className="relative w-full h-full md:h-auto md:max-h-[80vh] md:max-w-md md:rounded-2xl bg-[#1e1e1e] p-5 flex flex-col">
                ...
                <div className="flex-grow flex flex-col justify-center items-center">
                    ...
                    {/* Title */}
                    <h2 className="text-xl text-white text-center font-medium mb-4">Sign In to WorldBall</h2>

                    {/* Social Login Buttons - Row 1: Facebook and Apple side by side */}
                    ...
                    <div className="mb-3 w-full">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-xl bg-[#333333] text-white border-none focus:outline-none focus:ring-1 focus:ring-gray-500"
                        />
                    </div>
                    ...
                    {/* Stay Logged and Recover Password */}
                    <div className="flex justify-between items-center w-full mb-5">
                        <div className="flex items-center">
                            <input
                                ...
                                className="h-4 w-4 rounded bg-[#333333] border-gray-600 text-red-600 focus:ring-0 focus:ring-offset-0"
                            />
                            <label htmlFor="stayLogged" className="ml-2 text-xs text-gray-400">
                                Stay Logged
                            </label>
                        </div>
                    ...
                    {/* Sign In Button */}
                    <button className="w-full py-3 px-4 rounded-full bg-red-600 text-white font-semibold hover:bg-red-700 transition-colors mb-3">
                        SIGN IN
                    </button>
                    ...
                    <div className="text-center text-xs">
                        ...
                        <button onClick={handleSignUpClick} className="text-red-500 hover:text-red-400">
                            Create an Account
                        </button>
                    </div>
                </div>
